...
`NOT_APPLICABLE` 은 서로 다른 뜻입니다 ([UNKNOWN_POLICY.md](../04_PROFILE_AND_INPUT_CONTRACT/UNKNOWN_POLICY.md)).
...
관련 문서: [ARCHITECTURE.md](../03_SEMANTIC_ACTION/ARCHITECTURE.md) · [API_CONTRACT.md](../02_API_CONTRACT/API_CONTRACT.md) · [SAFETY_POLICY.md](../05_SAFETY_AND_BOUNDARY/SAFETY_POLICY.md)
