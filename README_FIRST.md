...
| 문서 | 내용 |
| --- | --- |
| [WHAT_YOU_BUILD](docs/WHAT_YOU_BUILD.md) | 참가팀이 만드는 것 |
| [WHAT_WE_PROVIDE](docs/WHAT_WE_PROVIDE.md) | KioBridge 가 제공하는 것 |
| [MAPPING_GUIDE](docs/MAPPING_GUIDE.md) | Profile Mapper 작성법 |
| [PROFILE_DATA_DICTIONARY](docs/PROFILE_DATA_DICTIONARY.md) | 프로필 필드 사전 |
| [SESSION_CONTEXT_DICTIONARY](docs/SESSION_CONTEXT_DICTIONARY.md) | SessionContext 필드 사전 |
| [ENUM_REFERENCE](docs/ENUM_REFERENCE.md) | 공식 enum |
| [API_CONTRACT](docs/API_CONTRACT.md) | API 전체 |
