...
/**
 * S04a·S04b QR 연동 — **아직 만들지 않았다.**
 *
 * 자리만 뚫어 둔 것이다. 화면을 파일로 나눠 동시에 만들 참인데, 자리가 없으면
 * 사람마다 App.tsx 를 고쳐야 하고 그러면 한 파일에서 다시 줄을 서게 된다.
 * 담당: 레인 B
 *
 * 만들 것: 매장 QR 을 카메라로 읽는다(BarcodeDetector). 우리가 QR 을 만드는 것이 아니다. 폴백 둘 — 직접 입력·직원 요청.
 *
...
export function QrConnect() {
  ...
  return (
    <section className="card" aria-label="S04a·S04b QR 연동">
      <h2>S04a·S04b QR 연동</h2>
