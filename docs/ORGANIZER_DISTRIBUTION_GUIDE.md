...
`[운영진]` KioBridge Simulation Kit **v5.1.4 Participant Edition**
...
```
release/kiobridge-simulation-kit-v5.1.4-participant.zip
release/kiobridge-simulation-kit-v5.1.4-participant.zip.sha256
```
...
3. 전체 개발폴더 ZIP 배포 금지
4. 공식 제품 버전 공지 — **5.1.4**
5. Input Contract 버전 공지 — **1.0.0** (이전 릴리스와 동일, 재작업 불필요)
...
> KioBridge Simulation Kit v5.1.4 을 배포합니다.
>
...
| `participant:progress` | 9단계 구현 상태 |
...
관련: [ONBOARDING_VIDEO_SCRIPT_7_MINUTES.md](ONBOARDING_VIDEO_SCRIPT_7_MINUTES.md)
